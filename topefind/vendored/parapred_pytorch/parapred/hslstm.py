# -*- coding: utf-8 -*-
"""
    Adapted from https://github.com/huggingface/torchMoji/blob/master/torchmoji/lstm.py
    There has been a fix in how the hard sigmoid LSTM handles packed sequences.
